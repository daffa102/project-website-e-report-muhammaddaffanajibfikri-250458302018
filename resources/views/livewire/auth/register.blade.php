<div id="auth-left">
    ...
    <p class="auth-subtitle mb-5">
        Register with your data, then you can login to your account in our website
    </p>

    <form wire:submit="register">
        <div class="form-group position-relative has-icon-left mb-4">
            <input type="text" wire:model="name" class="form-control form-control-xl" placeholder="Name">
        ...
        <div class="form-group position-relative has-icon-left mb-4">
            <input type="number" wire:model="number_whatsapp" class="form-control form-control-xl"
        ...
        <div class="form-group position-relative has-icon-left mb-4">
            <input type="file" wire:model="foto" class="form-control form-control-xl"
        ...
        <div class="form-group position-relative has-icon-left mb-4">
            <textarea name="alamat" wire:model="alamat" class="form-control form-control-xl" placeholder="Alamat"></textarea>
            <div class="form-control-icon">
                <i class="bi bi-shield-lock"></i>
            </div>
        </div>
    ...
    <div class="text-center mt-5 text-lg fs-4">
        <p class="text-gray-600">Already have an account? <a href="auth-register.html" class="font-bold">Login</a>.</p>
